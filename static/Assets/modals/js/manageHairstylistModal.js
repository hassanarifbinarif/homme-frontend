        ...
        response.json().then(function(res) {
            ...
            if (response.status == 200 && res.data.length > 0) {
                res.data.forEach((item) => {
                    stylistData.push({id: item.id, fullname: item.fullname, action: ""});
                    hairstylistTableBody.innerHTML += `<tr data-id="stylist-row-${item.id}">
                                                            ...
                                                            <td>
                                                                <div class="hairstylist-operations">
                                                                    <svg class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                                                    ...
                                                                    <svg class="cursor-pointer" onclick="toggleStylistInputs(${item.id})" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
